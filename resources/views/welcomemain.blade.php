...
<link rel="stylesheet" type="text/css" href="{{asset('jub/icomoon/icomoon.css')}}">

<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet"
  integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">

<link rel="stylesheet" type="text/css" href="{{asset('jub/css/vendor.css')}}">
...
<body>
  ...
  <nav class="main-menu d-flex navbar navbar-expand-lg p-2 py-3 p-lg-4 py-lg-4 ">
    <div class="container-fluid">
      <div class="main-logo d-lg-none">
        <a href="{{url('/')}}">
          <img src="{{asset('jub/images/logo.png')}}" alt="logo" class="img-fluid">
        </a>
      </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-6 mt-5">
          <img src="{{asset('jub/images/billboard-img.jpg')}}" alt="img" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="about" class="padding-medium mt-xl-5">
    <div class="container">
      <div class="row align-items-center mt-xl-5">
        ...
        <img src="{{asset('jub/images/about-img.jpg')}}" alt="img" class="img-fluid rounded-circle">
        </div>
        <div class="col-md-5 mt-5 mt-md-0">
          ...
          <a href="#" class="btn btn-primary px-5 py-3 mt-4">Learn more</a>
  ...
  <section id="courses" class="padding-medium">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item1.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item2.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item3.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item4.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item5.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item6.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item7.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="#"><img src="{{asset('jub/images/item8.jpg')}}" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
      ...
      <div class="text-center mt-4">
        <a href="#" class="btn btn-primary px-5 py-3">View all courses</a>
      </div>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  ...
                  <div class="row">
                    <div class="col-3"> <img src="{{asset('jub/images/reviwer1.jpg')}}" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Condimentum vel viverra morbi quisque lobortis eu leo. A nulla pulvinar at
                    ...
                    nunc sapien egestas at cursus. ”</p>
                  <div class="row">
                    <div class="col-3"> <img src="{{asset('jub/images/reviwer2.jpg')}}" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Condimentum vel viverra morbi quisque lobortis eu leo. A nulla pulvinar at
                    ...
                    nunc sapien egestas at cursus. ”</p>
                  <div class="row">
                    <div class="col-3"> <img src="{{asset('jub/images/reviwer3.jpg')}}" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="{{asset('jub/images/teacher1.jpg')}}" class="img-fluid rounded-3" alt="image">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="{{asset('jub/images/teacher2.jpg')}}" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="{{asset('jub/images/teacher3.jpg')}}" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="{{asset('jub/images/teacher4.jpg')}}" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="{{asset('jub/images/teacher5.jpg')}}" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
  ...
  <script src="{{asset('jub/js/jquery-1.11.0.min.js')}}"></script>
  <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
    integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
    crossorigin="anonymous"></script>
  <script src="{{asset('jub/js/plugins.js')}}"></script>
  <script src="{{asset('jub/js/script.js')}}"></script>
